...
public class DirtBlock extends Block {
	...
	public DirtBlock(Location location) {
		super(location, new GameTexture(Game.getInstance().getTextureAtlas().getImage(BlockMaterial.DIRT_BLOCK.getDisplayname()), false).setSize(Game.blocksize, Game.blocksize));
